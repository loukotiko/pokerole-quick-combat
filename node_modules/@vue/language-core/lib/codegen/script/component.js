...
function* generateComponentSetupReturns(scriptSetupRanges) {
    ...
    if (scriptSetupRanges.props.define) {
        ...
        yield `$props: __VLS_makeOptional(${scriptSetupRanges.props.name ?? `__VLS_props`}),${utils_1.newLine}`;
        yield `...${scriptSetupRanges.props.name ?? `__VLS_props`},${utils_1.newLine}`;
    }
    // fill $emit
    if (scriptSetupRanges.emits.define) {
        yield `$emit: ${scriptSetupRanges.emits.name ?? '__VLS_emit'},${utils_1.newLine}`;
    }
}
